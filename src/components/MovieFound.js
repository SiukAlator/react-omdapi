...
class MovieFound extends React.Component {
    ...
    viewDetail() {
        ...
        $.ajax({
            ...
            success: (searchResult) => {
                console.log('OK!:', searchResult.Title);
    ...
    favorite(){
        ...
        if (arrayFavorite != null && arrayFavorite != "")
        {
            ...
            index = arrayFavorite.indexOf(this.props.movie.imdbID);
        }
        ...
        else
        {
            if (arrayFavorite == null || arrayFavorite == "")
                arrayFavorite = [];
            arrayFavorite.push(this.props.movie.imdbID);
            localStorage.setItem('favorites', JSON.stringify(arrayFavorite));
    ...
    render() {
        ...
        return <div class="col-sm-6 col-md-4" >
            <div class="thumbnail">
                ...
                <a href='#' onClick={this.favorite.bind(this)}><img id={idImg} src={notFavorite} class="notFavorite"></img></a>
                <img src={srcImg} alt="poster" class={classImg} />
                <div class="caption">
                    <h3>{this.props.movie.Title}</h3>
                    <p>Year: {this.props.movie.Year}</p>
                    <p>
                        <a href="#" class="btn btn-primary" role="button" onClick={this.viewDetail.bind(this)}>Ver</a>
                        {/* <a href="#" class="btn btn-default" role="button">Favoritos</a> */}
                    </p>
                </div>
            </div>
        </div>;
